<?php
//blog
function pr_theme_blog_3_columns($atts, $content="", $component="blog_3_columns")
{
	global $themename;
	if(isset($_GET["atts"]))
...
//ajax pagination
add_action("wp_ajax_theme_blog_3_columns_pagination", "pr_theme_blog_3_columns");
add_action("wp_ajax_nopriv_theme_blog_3_columns_pagination", "pr_theme_blog_3_columns");
